...
class ArticuloController extends AbstractController
{
     ...
     */
    public function index(PaginatorInterface $paginator, ArticuloRepository $articuloRepository, Request $request): Response
    {
        $articulosQuery = $articuloRepository->searchAllArticles();

        $pagination = $paginator->paginate(
            $articulosQuery, /* query NOT result */
